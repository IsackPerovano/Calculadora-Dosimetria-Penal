        ...
        <div className="h-115 w-250 border-2 rounded-[15px] pl-3.5 border-[#d9d9d8] bg-white ml-50 mt-5">
           ...
           <div className='pt-5 grid grid-cols-2'>
                ...
                <label className="cursor-pointer">
                    ...
                    <div className="flex  items-center pl-3  rounded-[10px] h-17.5 w-120
                                    bg-[#1E2C4B] text-white
                                    peer-checked:bg-[#BCE7FD] peer-checked:text-[#1E2C4B] transition-colors duration-200">
                ...
                <label className="cursor-pointer pt-1">
                    <input type="checkbox" className="peer hidden" />
                    <div className="flex gap-4 items-center pl-3  rounded-[10px] h-17.5 w-120
                                    bg-[#1E2C4B] text-white
                                    peer-checked:bg-[#BCE7FD] peer-checked:text-[#1E2C4B]  transition-colors duration-200">
                        <div className="flex flex-col">
                            <h4 className="poppins font-bold">
